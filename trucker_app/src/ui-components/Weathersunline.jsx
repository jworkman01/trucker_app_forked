...
export default function Weathersunline(props) {
  ...
  return (
    <Icon
      ...
      {...rest}
      {...getOverrideProps(overrides, "Weathersunline")}
    ></Icon>
  );
}
