...
export default function Logosspotify(props) {
  ...
  return (
    <Icon
      ...
      {...rest}
      {...getOverrideProps(overrides, "Logosspotify")}
    ></Icon>
  );
}
