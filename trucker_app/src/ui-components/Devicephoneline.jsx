...
export default function Devicephoneline(props) {
  ...
  return (
    <Icon
      ...
      {...rest}
      {...getOverrideProps(overrides, "Devicephoneline")}
    ></Icon>
  );
}
