...
export default function Buildingsstore2fill(props) {
  ...
  return (
    <Icon
      ...
      {...rest}
      {...getOverrideProps(overrides, "Buildingsstore2fill")}
    ></Icon>
  );
}
