...
export default function Logoslinkedin(props) {
  ...
  return (
    <Icon
      ...
      {...rest}
      {...getOverrideProps(overrides, "Logoslinkedin")}
    ></Icon>
  );
}
