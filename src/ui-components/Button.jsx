...
export default function Button(props) {
  ...
  const variants = [
    {
      overrides: {
        "Button Icon184256": { width: "20px", height: "20px" },
        label: {
          fontSize: "20px",
        ...
        "Button Icon184258": { width: "20px", height: "20px" },
        Button: {
    ...
    {
      overrides: {
        "Button Icon184256": { width: "14px", height: "14px" },
        label: {
          fontSize: "14px",
          color: "rgba(255,255,255,1)",
          lineHeight: "21px",
        ...
        "Button Icon184258": { width: "14px", height: "14px" },
        Button: {
          border: "1px SOLID rgba(0,0,0,0)",
          borderRadius: "4px",
    ...
    {
      overrides: {
        "Button Icon184256": { width: "24px", height: "24px" },
        label: {
          fontSize: "14px",
          color: "rgba(92,102,112,1)",
          lineHeight: "21px",
        ...
        "Button Icon184258": { width: "24px", height: "24px" },
        Button: {
          borderRadius: "4px",
  ...
  return (
    ...
    >
      <View
        ...
        {...getOverrideProps(overrides, "Button Icon184256")}
      ></View>
      <Text
        fontFamily="Inter"
        fontSize="16px"
      ...
      <View
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Button Icon184258")}
      ></View>
    </Flex>
  );
}
