...
export default function CartCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCurrentItemValue(undefined);
    setPrice(initialValues.price);
    setErrors({});
  };
  const [currentItemValue, setCurrentItemValue] = React.useState(undefined);
  ...
  return (
    ...
    >
      <ArrayField
        ...
        currentFieldValue={currentItemValue}
        label={"Item"}
        items={item}
        hasError={errors.item?.hasError}
        setFieldValue={setCurrentItemValue}
        inputFieldRef={itemRef}
      ...
      >
        <TextField
          ...
          onBlur={() => runValidationTasks("item", currentItemValue)}
