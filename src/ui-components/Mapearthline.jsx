...
export default function Mapearthline(props) {
  ...
  return (
    <Icon
      ...
      {...rest}
      {...getOverrideProps(overrides, "Mapearthline")}
    ></Icon>
  );
}
