...
export default function Financeshoppingcartline(props) {
  ...
  return (
    <Icon
      ...
      {...rest}
      {...getOverrideProps(overrides, "Financeshoppingcartline")}
    ></Icon>
  );
}
