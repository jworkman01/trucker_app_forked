...
export default function CustomNavBar(props) {
  ...
  const accountOnClick = useNavigateAction({
    type: "url",
    url: "/AccountPage",
  });
  const profileOnClick = useNavigateAction({
    type: "url",
    url: "/ProfilePage",
  });
  const catalogOnClick = useNavigateAction({
    type: "url",
    url: "/CatalogPage",
  });
  const lOGOOnClick = useNavigateAction({ type: "url", url: "/HomePage" });
  return (
    <View
      width="1440px"
      height="81px"
