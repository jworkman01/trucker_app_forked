...
export default function Systemeyeline(props) {
  ...
  return (
    <Icon
      ...
      {...rest}
      {...getOverrideProps(overrides, "Systemeyeline")}
    ></Icon>
  );
}
