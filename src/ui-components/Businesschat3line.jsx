...
export default function Businesschat3line(props) {
  ...
  return (
    <Icon
      ...
      {...rest}
      {...getOverrideProps(overrides, "Businesschat3line")}
    ></Icon>
  );
}
