...
export default function Financeshoppingcartfill(props) {
  ...
  return (
    <Icon
      ...
      {...rest}
      {...getOverrideProps(overrides, "Financeshoppingcartfill")}
    ></Icon>
  );
}
